...
function addTravellingWaveEquation(name) {
  ...
  const eqn = figure.add({
    ...
    forms: {
      ...
      shiftedG_4: [sub('g_1', 'shifted'), 'equals1', 'g', brac(['x_1', 'min', tc([under('shift'), 'shift_1'], scale(lines([['propagation ', 'v', 'elocity']], 1), 0.8, 'center'), 'arrow1', 0.15, 0.15)], 2)],
      shiftedG_5: [sub('g_1', 'shifted'), 'equals1', 'g', brac(['x_1', 'min', tc([under('shift'), 'shift_1'], scale(lines([['propagation ', 'v', 'elocity'], ['propagation _1', 't_1', 'ime']], 1, 'center'), 0.8), 'arrow1', 0.15, 0.15)], 2)],
  ...
  const description = figure.add({
    ...
    elements: {
      ...
      'distance the wave has propagated since the initial time': { color: colorPurple },
        ...
        content: {
          lines: {
            content: [
              ...
              [t(['distance the wave has propagated since the initial time'], 6), '_.'],
            ],
            baselineSpace: 1.2,
            justify: 'center',
          },
